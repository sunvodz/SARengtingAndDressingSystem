...
export class StockComponent implements OnInit {
  ...
  displayedColumns: string[] = ['PID', 'productIds', 'productName', 'productPrice', 'productQuantity', 'types', 'statuses'];
  displayedColumnss: string[] = ['PID', 'productIds', 'detail', 'data'];
  ...
  delete() {
   ...
   selectRow(row) {
    ...
    this.views.selectProductIds = row.productIds;
  ...
  electRow(row) {
    ...
    this.views.selectProductIds = row.product.productIds;
 ...
 updateproduct() {
   ...
   if (!this.views.productIds) {
     this.views.productIds = this.views.selectProductIds;
   }
   ...
   this.httpClient.put('http://localhost:8080/product/updateproduct/' + this.views.prodID + '/' + this.views.productIds + '/' + this.views.productName + '/'
  ...
  updatedetail() {
    ...
    this.httpClient.put('http://localhost:8080/description/updatedetail/' +  this.views.prodID + '/' + this.views.detID + '/' + this.views.data,
      this.views, )
      .subscribe(
        data => {
          if (data)  {
  ...
  addproduct() {
    if (this.views.productID === '') {
      ...
      this.httpClient.post('http://localhost:8080/product/add/' + this.views.productIds + '/' + this.views.productName
